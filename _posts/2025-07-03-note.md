...
5. 생성된 컨테이너가 작동중(■)인지 확인 <div class="card mb-3"><img class="card-img-top" src="https://github.com/Katsudon8991/katsudon8991.github.io/blob/main/img/note/docker-install2.PNG?raw=true"/></div>

6. chrome 주소창에 localhost 입력

7. 잘 작동하는 지 확인 <div class="card mb-3"><img class="card-img-top" src="https://github.com/Katsudon8991/katsudon8991.github.io/blob/main/img/note/docker-install3.PNG?raw=true"/></div>
